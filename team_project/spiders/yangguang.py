import scrapy
from team_project.items import YangguangItem
...
class yangguangSpider(RedisSpider):
    name = 'yangguang'
    ...
    def parse_item(self, response):
        ...
        for pic in pic_list:
            try:
                ...
                try:
                    response = requests.get(pic_src)
                except Exception:
                    pass
                else:
                    img_srcs.append(pic_src)
